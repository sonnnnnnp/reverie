...
type Querier interface {
	...
	GetFollowingPostTimeline(ctx context.Context, arg GetFollowingPostTimelineParams) ([]GetFollowingPostTimelineRow, error)
	...
	GetPostTimeline(ctx context.Context, arg GetPostTimelineParams) ([]GetPostTimelineRow, error)
	...
	GetUserPostTimeline(ctx context.Context, arg GetUserPostTimelineParams) ([]GetUserPostTimelineRow, error)
